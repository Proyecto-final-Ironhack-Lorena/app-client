...
const ImageUploader = () => {
  ...
  return (
    <Button color="secondary" id="buttImage" variant="contained" onClick={handleClickButon}>{!selectedImage && "Añadir foto" }
      <input type="file" ref={inputRef} onChange={handleImageChange} style={{display: "none"}}/>
      {selectedImage && <img src={selectedImage} alt="Selected" style={{height: "100px", width: "100px"}} />}
      </Button>
  );
};
